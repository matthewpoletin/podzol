...
bool Graphics::Init(void)
{
	...
	u8g_Init8Bit(&m_u8g, &m_device, PN(2,0), PN(2,1), PN(2,2), PN(2,3), PN(2,4), PN(2,5), PN(2,6), PN(2,7), PN(3, 0), PN(3,3), PN(3,4), PN(3,2), PN(3,1), PN(3,5));
...
void Graphics::DrawText(const u8g_fntpgm_uint8_t* font, MyString text, int posX, int posY)
{
	u8g_SetFont(&m_u8g, font);
	u8g_DrawStr(&m_u8g, posX, posY, text.c_str());
}
